...
static inline int cabac_decode_decision(h264d_cabac_t *cb, dec_bits *st, int ctxIdx)
{
	...
	static const int8_t state_trans0[64][2]= {
		{-62, 1}, {-61, 2}, {-60, 3}, {-59, 4},
		{-58, 5}, {-57, 6}, {-56, 7}, {-55, 8},
		{-54, 9}, {-53, 10}, {-52, 11}, {-51, 12},
		{-50, 13}, {-49, 14}, {-48, 15}, {-47, 16},
		{-46, 17}, {-45, 18}, {-44, 19}, {-43, 20},
		{-42, 21}, {-41, 22}, {-40, 23}, {-39, 24},
		{-38, 25}, {-37, 26}, {-36, 27}, {-35, 28},
		{-34, 29}, {-33, 30}, {-32, 31}, {-31, 32},
		{-30, 33}, {-29, 34}, {-28, 35}, {-27, 36},
		{-26, 37}, {-25, 38}, {-24, 39}, {-23, 40},
		{-22, 41}, {-21, 42}, {-20, 43}, {-19, 44},
		{-18, 45}, {-17, 46}, {-16, 47}, {-15, 48},
		{-14, 49}, {-13, 50}, {-12, 51}, {-11, 52},
		{-10 ,53}, {-9, 54}, {-8, 55}, {-7, 56},
		{-6, 57}, {-5, 58}, {-4, 59}, {-3, 60},
		{-2, 61}, {-1, 62}, {-1, 62}, {0, 63}
	};
	static const int8_t state_trans1[64][2] = {
		{-63, 0}, {-63, 0}, {-62, 1}, {-61, 2},
		{-61, 2}, {-59, 4}, {-59, 4}, {-58, 5},
		{-57, 6}, {-56, 7}, {-55, 8}, {-54, 9},
	 	{-54, 9}, {-52, 11}, {-52, 11}, {-51, 12},
		{-50, 13}, {-50, 13}, {-48, 15}, {-48, 15},
		{-47, 16}, {-47, 16}, {-45, 18}, {-45, 18},
		{-44, 19}, {-44, 19}, {-42, 21}, {-42, 21},
		{-41, 22}, {-41, 22}, {-40, 23}, {-39, 24},
		{-39, 24}, {-38, 25}, {-37, 26}, {-37, 26},
		{-36, 27}, {-36, 27}, {-35, 28}, {-34, 29},
		{-34, 29}, {-33, 30}, {-33, 30}, {-33, 30},
		{-32, 31}, {-31, 32}, {-31, 32}, {-30, 33},
		{-30, 33}, {-30, 33}, {-29, 34}, {-29, 34},
		{-28, 35}, {-28, 35}, {-28, 35}, {-27, 36},
		{-27, 36}, {-27, 36}, {-26, 37}, {-26, 37},
		{-26, 37}, {-25, 38}, {-25, 38}, {0, 63}
	};
	...
	if (offset < range) {
		binVal = valMPS;
		pStateIdx = state_trans0[pStateIdx][valMPS];
	} else {
		binVal = valMPS ^ 1;
		cb->offset = offset = offset - range;
		range = lps;
		valMPS = pStateIdx ? valMPS : valMPS ^ 1;
		pStateIdx = state_trans1[pStateIdx][valMPS];
	}
